...
boil.Level2.prototype = {
    ...
    create: function(){
        ...
        game.add.tween(enemys).to( { x: 250 }, 2500, Phaser.Easing.Linear.None, true, 0, 1000, true);
    ...
    update: function(){
        if (game.time.now - enemyshottime > 1500){
    ...
    overlaphandler : function(bullet,enemy){
        ...
        if(healthyList.list.length <= 0){changeState('Level3')};
